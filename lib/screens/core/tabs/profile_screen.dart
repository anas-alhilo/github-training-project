...
class _ProfileScreenState extends State<ProfileScreen> {
  ...
  void _loadUser() async {
    User? u = await UserDbController().getUserById(
      SharedPrefController().getValue<int>(PrefKeys.id.name)!,
    );

    if (u != null) {
      setState(() {
        _originalUser = u!;
        _fNameTextEditingController.text = u.fName;
        _lNameTextEditingController.text = u.lName;
        _emailTextEditingController.text = u.email;
        _passwordTextEditingController.text = u.password;
        _confirmPasswordTextEditingController.text = u.password;
        userId = u.id;
      });
    }
  }
      ...
      child: Padding(
        ...
        child: Column(
          ...
          children: [
                ...
                children: [
                  ...
                  PositionedDirectional(
                    ...
                    child: Container(
                      ...
                      child: IconButton(
                        onPressed: () => _showEditBottonSheet(),
                        icon: Icon(Icons.edit, size: 14.r, color: Colors.white),
                      ),
                    ),
                  ),
                ],
            ...
            SizedBox(height: 5.h),
            MyText(
              text: 'Junior Mobile Apps Developer',
              fontSize: 12,
            ...
            Align(
              alignment: AlignmentDirectional.centerStart,
              child: MyText(
                text: AppLocalizations.of(context)!.birth_date,
                fontSize: 12.sp,
                color: Color(0xFF7E848D),
              ),
            ),
                ...
                Row(
                  children: [
                    ...
                    IconButton(
                      ...
                      icon: Icon(Icons.cancel, color: Colors.red, size: 28.r),
                    ),
                  ],
                ),
  ...
  void _updateUser() async {
    ProcessResponse processResponse = await UserDbController().updateUser(
      user,
      context,
    );
  ...
  User get user {
    ...
    u.password = _passwordTextEditingController.text;
    u.id = userId;
    return u;
  }
}
